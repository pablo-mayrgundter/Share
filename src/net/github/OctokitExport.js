...
// Add exports so we can pass to the worker.
export const GITHUB_BASE_URL_AUTHED = process.env.GITHUB_BASE_URL
export const GITHUB_BASE_URL_UNAUTHED = process.env.GITHUB_BASE_URL_UNAUTHENTICATED
