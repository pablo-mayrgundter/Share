...
// Mock SVGLoader for bun compatibility
const mockSvgData = {
  paths: [{
    userData: { style: {} },
    subPaths: [],
...
/**
 * Mock SVGLoader for testing
 */
mock.module('three/examples/jsm/loaders/SVGLoader', () => ({
  SVGLoader: class SVGLoader {
    /**
     * @return {object}
     */
    parse() {
...
describe('svg', () => {
  it('getSvgGroupFromObj snapshot of PlaceMarkSvg matches', async () => {
